...
public class UserResume {
    ...
    public String getResumeTitile() {
        return resumeTitile;
    }

    public void setResumeTitile(String resumeTitile) {
        this.resumeTitile = resumeTitile == null ? null : resumeTitile.trim();
    }
